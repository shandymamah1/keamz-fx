...
async function analyse(symbol) {
  ...
  if (
    ...
    reason =
      "5M bullish trend and 1M bullish structure are aligned with sufficient entry confirmation.";
  ...
  if (
    ...
    reason =
      "5M bearish trend and 1M bearish structure are aligned with sufficient entry confirmation.";
